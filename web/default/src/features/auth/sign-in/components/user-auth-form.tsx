  ...
  return (
    <Form {...form}>
      ...
      >
            ...
            <FormItem className='relative'>
              ...
              <FormControl>
                <PasswordInput
                  ...
                  className='[&_input]:h-11 [&_input]:rounded-lg [&_input]:bg-background/70'
                  {...field}
                />
              </FormControl>
              <FormMessage />
              <Link
                to='/forgot-password'
                className='text-muted-foreground hover:text-primary absolute end-0 -top-0.5 text-sm font-medium'
              >
                {t('Forgot password?')}
              </Link>
            </FormItem>
        ...
        {/* Submit Button */}
        <Button
          className='mt-1 h-11 w-full justify-center gap-2 rounded-lg text-base shadow-sm'
