	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/self/aff", controller.GetAffCode)
		...
		agentRoute.Use(middleware.UserAuth())
		{
			...
			agentRoute.POST("/withdraw", controller.WithdrawCommission)
		}
		apiRouter.PUT("/user/:id/agent", middleware.AdminAuth(), controller.AdminSetAgentLevel)
